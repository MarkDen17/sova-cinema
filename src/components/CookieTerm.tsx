...
function CookieTerm({ setIsCookieAccepted }: CookieTermProps) {
  ...
  return (
    <div className="fixed bottom-2 left-2 max-w-lg p-8 bg-neutral-50 rounded-xl border">
      ...
      <p className="mt-4 pb-3 text-justify text-pretty text-(--primary-color) border-b">
        Мы используем <a href="https://ru.wikipedia.org/wiki/Cookie">cookie</a> на нашем сайте. Чтобы продолжить им
        пользоваться пожалуйста дайте свое согласие на работу с ними.
      </p>
      <div className="flex gap-2 pt-2 items-start">
        ...
        <p className="text-justify text-pretty text-(--primary-color) ">
          Технические (Обязательные). Их мы ипользуем для создания механизма авторизации. Без них функционал сайта не
          работает.
        </p>
      </div>
